...
def reg_check():
    ...
    while to_continue == False:
        ...
        print ("last three codons:",seq[reg_end-9:reg_end-6],seq[reg_end-6:reg_end-3],seq[reg_end-3:reg_end])
...
def write_result(i, x, p, tmp2, tmp3, aa, mut, mut_num):
    ...
    tmp2.append(mut_num)
    tmp3.append(mut_num)
    a=StructureCheck("hairpins", primer3.calc_hairpin(for_primer), tmforprim, warning2, tmp2)
    b=StructureCheck("hairpins", primer3.calc_hairpin(rev_primer), tmrevprim, warning3, tmp3)
    d=StructureCheck("homodimers", primer3.calc_homodimer(for_primer), tmforprim, warning2, tmp2)
    e=StructureCheck("homodimers", primer3.calc_homodimer(rev_primer), tmrevprim, warning3, tmp3)
    f=tmcheck(tmforprim)
    g=tmcheck(tmrevprim)
